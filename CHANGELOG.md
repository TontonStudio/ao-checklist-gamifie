...
- **Méta-tags pour partage social** : Ajout de balises Open Graph dans le HTML pour un partage optimisé
- **Images pour réseaux sociaux** : Nouvelles images optimisées pour le partage (AGC_SM.png et TTS_Logo_SM.png)
- **Description améliorée** : Texte descriptif optimisé pour les aperçus sur les réseaux sociaux
- **Lien canonique** : URL canonique définie pour un meilleur référencement
